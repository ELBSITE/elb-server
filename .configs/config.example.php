...
return [
    'modules' => [
        ...
        'Bss_Quickview' => 1,
        'Bss_RefundRequest' => 1,
        'Ebizmarts_Notification' => 1,
        'Ebizmarts_SagePaySuite' => 1,
        'Ebizmarts_SagePaySuiteCoupon' => 1,
        'Ebizmarts_SagePaySuiteFailedPaymentEmail' => 1,
        'Ebizmarts_SagePaySuiteFormCrypt' => 1,
        'Ebizmarts_SagePaySuiteLogger' => 1,
        'Experius_EmailCatcher' => 1,
        'Litespeed_Litemage' => 1,
        'Mageants_AdvanceReview' => 1,
        ...
        'Mageplaza_MassOrderActions' => 1,
        'Mageplaza_Smtp' => 1,
        'Meetanshi_CookieNotice' => 1,
        'PayPal_Braintree' => 1,
        'PayPal_BraintreeGraphQl' => 1,
        'SR_ModifiedCheckout' => 1,
        'Sparsh_CustomShippingMethod' => 1,
