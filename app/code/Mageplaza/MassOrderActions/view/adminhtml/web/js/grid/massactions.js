            ...
            defaultCallback: function (action, data) {
                switch (action.type){
                    case 'mp_order_comment':
                        var commentForm      = $('#mp-massorderactions-comment-form'),
                    ...
                    case 'mp_create_invoice':
                        var invoiceForm      = $('#mp-massorderactions-invoice-form'),
                    ...
                    case 'mp_create_shipment':
                        var shipmentForm      = $('#mp-massorderactions-shipment-form'),
                    ...
                    case 'mp_invoice_shipment':
                        var invoiceShipment      = $('#mp-massorderactions-invoice-shipment-form'),
